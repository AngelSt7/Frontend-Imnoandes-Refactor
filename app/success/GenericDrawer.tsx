...
export default function GenericDrawer({ width = '99', descriptionDrawer }: DrawerProps) {
    ...
    return (
        ...
        <DrawerComponent.Root onClose={closeModal} open={showModal} direction="right">
            <DrawerComponent.Portal>
                ...
                >
                    {/* bg-zinc-50 */}
                    <div className="bg-green-400  h-full w-full grow p-5 flex flex-col rounded-[16px] relative">
