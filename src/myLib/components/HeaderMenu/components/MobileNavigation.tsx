...
export function MobileNavigation({ navLinks, isMenuOpen, closeMenu, user, routeLogin }: MobileNavigationProps) {
  return (
    <div className="flex flex-col flex-1 justify-between p-6 ">
      ...
      <ButtonsNav user={user} routeLogin={routeLogin} styles="w-full mb-3" />
    </div>
  );
}