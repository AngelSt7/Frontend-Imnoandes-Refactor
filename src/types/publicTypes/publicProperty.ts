import { carrouselItemSchema, carrouselSchema, publicContactFormSchema, publicFilterAreaSchema, publicFilterBedroomsSchema, publicFilterPricesSchema } from "@/src/schema/public/property";
import { z } from "zod";
